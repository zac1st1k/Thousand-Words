...
@implementation XZZAlbumTableViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if ([segue.identifier isEqualToString:@"Album Chosen"]) {
        if ([segue.destinationViewController isKindOfClass:[XZZPhotosCollectionViewController class]]) {
            NSIndexPath *path = [self.tableView indexPathForSelectedRow];
            XZZPhotosCollectionViewController *targetViewController = segue.destinationViewController;
